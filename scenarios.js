...
const blizzard = {
    ...
    scenario: [
        ...
        new Story(175, "There's not a lot of loose branches and neither you nor your partner has a machete", 'Work with the snow around you', "Keep walking. You were close to home so you're bound to reach some sort of building. Hopefully people will be kind enough to let you in"),
        new Story(180, "While you're walking the wind chill quickly makes your body temperature plummet. The risk of  hypothermia increases every minute you are exposed to the cold weather. You and your partner become irrationally hot and remove your clothes. You both freeze to death and even worse are found naked.", null, null, 0.75),
        new Story(90, "Lucky for you there is already snow on the ground which you are able to shape and mold", "You and your partner start rolling/packing snow to create an igloo", 'Dig a snow cave into a nearby snow bank or drift'),
        new Story(84, "Before you have enough packed snow to make one wall you and your partner have exerted enough energy to justify a break. Little do you know lying down on snow eliminates all your body heat. You take a nap but never wake up.", null, null, 0.75),
        new Story(140, "When building your shelter there's conflicting opinions on how to ventilate it. Your partner believes the shelter should be packed as tight as possible with little to no opening while you suggest poking holes in the shelter. Do you...", "Follow your partner he's camped and hiked many more times than you", 'Poke holes in the shelter anyways'),
        new Story(148, "Your shelter is nearly complete. While your partner is finishing his last shift digging it out you decide to prepare for a long storm ", "Search for clean snow to hydrate yourselves.", 'Search for branches and leaves to fortify your snow cave'),
        new Story(147, "It seems like a good idea at first and you could really use something to drink. However, your body must melt the ice before it can be consumed. Consuming the snow exhausts you and your body temperature continue to drop until you pass out and eventually freeze.", null, null, 0.75),
        new Story(150, "You are able to find some movable boulders and weathered wooden planks from a nearby dock.", "Once you and your partner are huddled inside the snow cave, stack the rocks in front of the opening to block any wind.", 'Once you and your partner are huddled inside tightly stack the planks in front of the opening to block any wind'),
        new Story(149, "Your strategy is a success! The boulders block the wind while leaving enough room to let you and your partner breathe. The storm eventually dies down and the temperature rises enough for you to find your way home.", null, null, 0),
        new Story(152, "Your snow cave is warm enough however when you stacked the planks you blocked any incoming oxygen. Fun Fact: many people stranded in blizzards actually die of carbon monoxide poisoning.", null, null, 0.75),
        new Story(95, "Your shelter is nearly complete. While your partner is finishing his last shift digging it out you decide to prepare for a long storm ", "Search for clean snow to hydrate yourselves.", 'Search for branches and leaves to fortify your snow cave'),
        new Story(94, "It seems like a good idea at first and you could really use something to drink. However, your body must melt the ice before it can be consumed. Consuming the snow exhausts you and your body temperature continue to drop until you pass out and eventually freeze.", null, null, 0.75),
        new Story(98, "You are able to find some movable boulders and weathered wooden planks from a nearby dock.", "Once you and your partner are huddled inside the snow cave, stack the rocks in front of the opening to block any wind.", 'Once you and your partner are huddled inside tightly stack the planks in front of the opening to block any wind'),
        new Story(96, "Your strategy is a success! You could've poked holes in the snow cave for more breathing room though. The boulders block the wind while leaving enough room to let you and your partner breathe. The storm eventually dies down and the temperature rises enough for you to find your way home.", null, null, 0.10),
        new Story(100, "Your snow cave is warm enough however when you stacked the planks you blocked any incoming oxygen. Fun Fact: many people stranded in blizzards actually die of carbon monoxide poisoning.", null, null, 0.75)
    ]
}
